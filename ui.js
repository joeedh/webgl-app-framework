  ...
  */
  ...
  var UI = exports.UI = class UI {
    ...
    check(path, name) {
        ...
        if (this._path_get(path) === undefined) {
          console.warn("Unknown path", startpath);
          return;
        }
        ...
        Object.defineProperty(iface, id, {
          get : function() {
            let ret = this2._path_get(path);
            return ret === undefined ? false : ret[0];
          },
    ...
    */
    listenum(path, name, enummap, defaultval, callback) {
        ...
        if (path !== undefined && this._path_get(path) === undefined) {
          console.warn("Unknown path", startpath);
          return;
        }
