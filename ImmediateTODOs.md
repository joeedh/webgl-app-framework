...
[ ]: make sure sculpt mask painting is implemented and works
[ ]: make sure all sculptcore SculptTool enum entries have icons, create if necassary
[ ]: smoothing brushes should have accumulate on by default
...
[ ]: the brush invert flag isn't respected.  it should invert strength for most brushes (except for smooth brushes).
...
[ ]: the draw sharp brush is far too strong and explodes geometry
[ ]: inflate brush should have accumulate on by default
[ ]: clay brush should have accumulate on by default
...
[ ]: the add menu in the electron/web apps shows `litemesh.add_cube(dimen=100)` instead of the toolop's ui name.  fix it.
