import {AttrRef} from "../../../scripts/mesh/mesh_customdata";
...
export interface IGridBaseConstructor<type = any> {
  new(): type;

  updateSubSurf(mesh: Mesh, cd_grid: number, check_coords?: boolean): void;
}
...
export class GridBase extends CustomDataElem<any> {
  ...
  static meshGridRef(mesh: any): AttrRef<GridBase>;
...
import {Mesh} from "../../../scripts/mesh/mesh";
