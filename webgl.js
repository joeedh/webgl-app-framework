...
define([
  ...
  let IntUniform = exports.IntUniform = class IntUniform {
    constructor(val) {
      this.val = val;
    }
  }
  ...
  var init_webgl = exports.init_webgl = function init_webgl(canvas, params) {
  ...
  let hashShader = exports.hashShader = function hashShader(sdef) {
    let hash;
  ...
  */
  ...
  exports.getShader = function getShader(gl, shaderdef) {
  ...
  var ShaderProgram = exports.ShaderProgram = class ShaderProgram {
  ...
  var RenderBuffer = exports.RenderBuffer = class RenderBuffer {
    constructor() {
      this._layers = {};
    }
  ...
  var Texture = exports.Texture = class Texture {
  ...
  var DrawMats = exports.DrawMats = class DrawMats {
    constructor() {
  ...
  //simplest camera
  var Camera = exports.Camera = class Camera extends DrawMats {
    constructor() {
      super();
