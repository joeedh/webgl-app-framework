...
import './pbvh_holefiller.ts';
import './pbvh_sculptops.ts';
import './pbvh_base.ts';
import './pbvh_texpaint.ts';

import {calcConcave, getBVH} from './pbvh_base.ts';
  ...
  */
  drawObject(gl: WebGL2RenderingContext, uniforms: any, program: any, object: any, mesh: any): boolean {
    ...
    **/
    ...
    function genNodeMesh_index(node: any): void {
      let nodes: any[] = [];

      //count verts
      function buildNodes(n: any): void {
        if (n.leaf) {
          nodes.push(n);
        }
    ...
    function genNodeMesh(node: any): void {
      if (!drawColPatches) {
      ...
      function countrec(node: any): void {
        if (node.leaf) {
      ...
      function rec(node: any): void {
        ...
        function doline(sm: any, t1: Vector3, t2: Vector3, v1: any, v2: any): void {
          if (have_grids) {
            sm.line(t1, t2);
          } else {
