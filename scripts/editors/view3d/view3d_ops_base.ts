import {ToolOp, Vector2, Vector3, Vector4} from "../../path.ux/scripts/pathux.js";
import {ToolOpBase} from "../../core/toolopbase";
import {DrawLine} from "./view3d";

export abstract class View3DOp<InputSet, OutputSet> extends ToolOpBase<InputSet, OutputSet> {
  drawlines: any[];
  drawquads: any[];
  drawlines2d: any[];
