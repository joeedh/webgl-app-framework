let _fbo = undefined; //debug console use only!

define([
  "util", "vectormath", "webgl", "simplemesh"
], function(util, vectormath, webgl, simplemesh) {
  "use strict";
  
  let exports = _fbo = {};
  
  let FBO = exports.FBO = class FBO {
  ...
  let FrameStage = exports.FrameStage = class FrameStage extends FBO {
...
void main(void) {
  ...
  let FramePipeline = exports.FramePipeline = class FramePipeline {
