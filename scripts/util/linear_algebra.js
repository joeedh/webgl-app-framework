...
define(['util'], function (util) {
    ...
    toString: function (dec) {
      ...
      if (n == 1.0) {
        ...
        for (var i = 0; i < this.length; i++) {
          ...
          if (this[i] == undefined) ret += 'undefined'
          else ret += this[i].toFixed(dec)
        }
        ret += ']'
  ...
  /*
    var _seed = 0;
    function rand() {
      var p = 0.5 + (_seed*0.001 + 0.01);
      _seed++;
      
      return fract(1.0 / (0.0000001*p+0.00000001));
    }
    
    var tm = new Matrix(5, 5);
    tm.makeIdentity();
    var det = 0;
    ...
    var tm2 = new Matrix(5, 5).load(tm);
    //console.log(""+tm2, tm.determinant())
    console.log(tm.determinant());
