//do not use in code; for accessing module during debugging
var _camera_controls = undefined;

define([
  "util", "vectormath", "webgl", "events"
], function(util, vectormath, webgl, events) {
  "use strict";

  var exports = _camera_controls = {};
  ...
  exports.CameraControls = class CameraControls extends EventHandler {
    constructor() {
      super();
