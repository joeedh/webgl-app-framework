import {Number3, Vector3} from '@framework/api'
...
import {BVHVertFlags, MDynVert} from '../../mesh/src/bvh.js'
import {Edge, Face, Loop, Mesh, Vertex} from '../../mesh/src/mesh.js'
import {CustomDataElem} from '../../mesh/src/customdata.js'
