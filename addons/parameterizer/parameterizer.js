...
/**
 * @param api { import('../scripts/addon/addon_base').AddonAPI<any> }
 */
export function register(api) {
  ...
  const {ParamizeModes} = api.mesh.paramizer
  const {SmoothMemoizer} = api.mesh.displacement
  const {MeshFlags} = api.mesh
